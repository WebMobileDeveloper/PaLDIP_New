(function () {
    ...
    angular
        .module('myApp')
        .controller('createByTextController', createByTextController)

    createByTextController.$inject = ['$state', '$scope', '$rootScope'];

    function createByTextController($state, $scope, $rootScope) {
