(function () {
    ...
    angular
        .module('myApp')
        .controller('responseOfExternalController', responseOfExternalController)
    ...
    function responseOfExternalController($state, $scope, $rootScope, $sce, $filter) {
        ...
        $scope.finalCalc = function () {
            ...
            userValues = [undefined, undefined, undefined]
            $scope.title = ["", "Group", "Others"]
            let groupSum = 0;
            let groupCount = 0;
            let allSum = 0;
            let allCount = 0;
            ...
            $scope.calcValues[1][2] = allSum
            $scope.labels.push("◼  Average of all other groups");
            $scope.colors.push("#0000FF");
            $scope.pointStyles.push('rect');
            $scope.radiuses.push(7);

            $scope.calcValues[2] = userValues
            $scope.labels.push("⏺  user results in this group");
                ...
                legend: {
                    ...
                    onClick: function (e, legendItem) {
                        ...
                        if (index < 2) {
                            ...
                            for (var i = 2; i < $scope.calcValues.length; i++) {
