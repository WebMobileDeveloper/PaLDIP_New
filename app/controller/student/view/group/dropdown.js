(function () {
    ...
    DropdownViewController.$inject = ['$state', '$scope', '$rootScope', '$sce'];

    function DropdownViewController($state, $scope, $rootScope, $sce) {
        $rootScope.setData('showMenubar', true);
        $rootScope.setData('backUrl', "dropdownAnswer");
        var max_length = 60;
        ...
        $scope.paintgraph = function (value, Dom) {
            if ($scope.numberOfAnswers == 0) {
                $rootScope.error("There is not any data!");
            }
