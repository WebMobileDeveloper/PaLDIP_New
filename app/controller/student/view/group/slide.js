(function () {
    ...
    angular
        .module('myApp')
        .controller('SlideViewController', SlideViewController)

    SlideViewController.$inject = ['$state', '$scope', '$rootScope', '$sce'];

    function SlideViewController($state, $scope, $rootScope, $sce) {
        $rootScope.setData('showMenubar', true);
        $rootScope.setData('backUrl', "slideAnswer");
