(function () {
    ...
    angular
        .module('myApp')
        .controller('GroupDropdownViewController', GroupDropdownViewController)

    GroupDropdownViewController.$inject = ['$state', '$scope', '$rootScope', '$sce'];

    function GroupDropdownViewController($state, $scope, $rootScope, $sce) {
        $rootScope.setData('showMenubar', true);
        $rootScope.setData('backUrl', "groupDropdownAnswer");
        var max_length = 60;
