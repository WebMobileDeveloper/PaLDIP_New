(function () {
    ...
    angular
        .module('myApp')
        .controller('GroupContingentViewController', GroupContingentViewController)

    GroupContingentViewController.$inject = ['$state', '$scope', '$rootScope', '$sce'];

    function GroupContingentViewController($state, $scope, $rootScope, $sce) {
        $rootScope.setData('showMenubar', true);
        $rootScope.setData('backUrl', "groupContingentAnswer");
        ...
        $scope.init = function () {
            ...
            $scope.answerRef.on('value', function (snapshot) {
                ...
                for (var key in snapshot.val()) {
                    ...
                    if (ansSnapshot.groupType == $rootScope.settings.groupType
                        && ansSnapshot.studentgroupkey == $rootScope.settings.groupKey
                        ...
                        if ($rootScope.settings.groupType == 'sub') {
                            if (ansSnapshot.subIndex != $rootScope.settings.subIndex) {
                                checkSameSubGroup = false;
                            }
                        } else {
                            if (ansSnapshot.secondIndex != $rootScope.settings.secondIndex) {
                                checkSameSubGroup = false;
                            }
                        }
