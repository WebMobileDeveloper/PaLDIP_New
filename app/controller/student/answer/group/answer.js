(function () {
    ...
    AnswerController.$inject = ['$state', '$scope', '$rootScope', '$sce', '$filter'];

    function AnswerController($state, $scope, $rootScope, $sce, $filter) {
        ...
        $scope.getSetQuestions = function () {
            ...
            $scope.setQuestionsRef.on('value', function (snapshot) {
                ...
                $scope.question = $scope.setQuestions[$rootScope.settings.questionKey];
