(function () {
    ...
    angular
        .module('myApp')
        .controller('ContingentAnswerController', ContingentAnswerController)

    ContingentAnswerController.$inject = ['$state', '$scope', '$rootScope', '$sce'];

    function ContingentAnswerController($state, $scope, $rootScope, $sce) {
