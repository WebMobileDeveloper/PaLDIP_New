(function () {
    ...
    angular
        .module('myApp')
        .controller('GroupSlideAnswerController', GroupSlideAnswerController)

    GroupSlideAnswerController.$inject = ['$state', '$scope', '$rootScope'];

    function GroupSlideAnswerController($state, $scope, $rootScope) {
        ...
        $scope.saveslideanswer = function () {        
            ...
            var answerData = {
                ...
                questionKey: $rootScope.settings.questionKey,
                question: $rootScope.settings.questionString,
                answer: $scope.slidetitles,
                answerval: $scope.slidegraph,
